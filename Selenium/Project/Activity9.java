...
/**
 * @author 04108E744 Create a job listing using the backend
 */
public class Activity9 {

	public static final Logger log = Logger.getLogger(Activity9.class.getName());
	...
	public void beforeMethod() {
		...
		log.info("------------------------Started Activity9 test--------------------------------");
	...
	public void createJobUsingBackend() {
		...
		driver.findElement(By.xpath(
				"//button[contains(@class,'components-button editor-post-publish-button editor-post-publish-button__button is-primary')]"))
				.click();

		// Click on word press icon.
		driver.findElement(By.xpath("//a[@class='components-button edit-post-fullscreen-mode-close has-icon']"))
				.click();
		...
		Assert.assertEquals(actualJobTitle, jobTitle, "The Jobs didn't match.");
	}

	@AfterMethod
	public void afterMethod() {
		log.info("------------------------Ended Activity9 test--------------------------------");
		// Close the browser
		driver.close();
	}
